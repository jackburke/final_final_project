...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { city: @instructor.city, first_name: @instructor.first_name, last_name: @instructor.last_name, school: @instructor.school, state: @instructor.state }
    end
  ...
  test "should update instructor" do
    put :update, id: @instructor, instructor: { city: @instructor.city, first_name: @instructor.first_name, last_name: @instructor.last_name, school: @instructor.school, state: @instructor.state }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
